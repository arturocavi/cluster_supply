...
------------------------- CLUSTER DE ELECTRÓNICA (2) -------------------------


---------- Producción Bruta ----------

-- Porcentaje del total estatal
-- Guardar como elec_prod_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como elec_prod_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como elec_pers_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como elec_pers_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como elec_acti_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como elec_acti_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como elec_unec_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como elec_unec_par_nac.csv
WITH 
    nac AS(
