...
------------------------- CLUSTER AUTOMOTRIZ (1) -------------------------


---------- Producción Bruta ----------

-- Porcentaje del total estatal
-- Guardar como auto_prod_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como auto_prod_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como auto_pers_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como auto_pers_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como auto_acti_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como auto_acti_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como auto_unec_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como auto_unec_par_nac.csv
WITH 
    nac AS(
