...
-- Guardar como tool_prod_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como tool_prod_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como tool_pers_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como tool_pers_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como tool_acti_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como tool_acti_par_nac.csv
WITH 
    nac AS(
...
-- Porcentaje del total estatal
-- Guardar como tool_unec_pct_ef.csv
WITH
    total_ef AS(
...
-- Participación del total nacional
-- Guardar como tool_unec_par_nac.csv
WITH 
    nac AS(
